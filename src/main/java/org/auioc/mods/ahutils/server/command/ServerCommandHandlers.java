...
public abstract class ServerCommandHandlers {
    public static int triggerClientCrash(CommandContext<CommandSource> ctx) throws CommandSyntaxException {
        ...
        for (GameProfile gameprofile : targets) {
            ...
            Loggers.info(String.format("Send TriggerCrashPacket to player %s (%s)", player.getName().getString(), player.getStringUUID()));
        }
